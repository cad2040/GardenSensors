...
<html>
    ...
    <body>
        ...
        $sqlupdate="UPDATE SoilSensors.DimPlants SET minSoilMoisture=".$_POST[soilminup].",
                           maxSoilMoisture=".$_POST[soilmaxup]." WHERE plant='".$_POST[plantsup]."'";
        if (mysqli_query($conn,$sqlupdate))
        {
        echo "Plant moisture updated successfully";
        } else {
