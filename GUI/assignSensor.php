...
<html>
    ...
    <body>
        ...
        $sqlplants="SELECT id, plant FROM SoilSensors.DimPlants WHERE plant ='".$_POST[plants]."'";
        ...
        $sensorscheck="SELECT * FROM SoilSensors.FactPlants WHERE sensor_id =".$sensorid;
        if($result = mysqli_query($conn, $sensorscheck))  {
        if (mysqli_num_rows($result)>0) {
        $sqlupdate="UPDATE SoilSensors.FactPlants SET plant_id =".$plantid." WHERE sensor_id=".$sensorid;
        ...
        $sqlinsert="INSERT INTO SoilSensors.FactPlants (sensor_id,plant_id,lastWatered) 
                  VALUES (".$sensorid.",".$plantid.",NULL)";
